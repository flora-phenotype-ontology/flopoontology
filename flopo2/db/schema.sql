...
CREATE TABLE IF NOT EXISTS trait_assertion (
  ...
  qualitative_value_relation TEXT NOT NULL DEFAULT '{}',
  bearer_context_qualities TEXT NOT NULL DEFAULT '[]',
  part_restrictions TEXT NOT NULL DEFAULT '[]',
  -- Per-operand/per-endpoint qualifiers (E2) as JSON; provenance only, never FAC identity.
  value_operands TEXT NOT NULL DEFAULT '[]',
  -- Positional/sub-part scope provenance (E3) as JSON; never FAC identity.
  bearer_scope TEXT NOT NULL DEFAULT '{}',
