...
def test_sensitive_botanical_proposals_keep_semantically_safe_parents():
    ...
    # Curator decision 2026-09-18: ascending sits under oblique orientation, itself an
    # orientation; spreading stays a direct orientation value.
    assert proposals["PATO-CAND:ascending"]["direct_parent_ids"] == "PATO:0002481"
    assert proposals["PATO-CAND:ascending"]["curator_decision"] == "accept_with_revision"
    assert proposals["PATO-CAND:spreading"]["direct_parent_ids"] == "PATO:0000133"
